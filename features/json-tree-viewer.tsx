...
export function JsonTreeViewer({ data, className = "" }: JsonTreeViewerProps) {
	...
	if (data === null || data === undefined) {
		return (
			<div
				className={`flex items-center justify-center h-full text-faint bg-background ${className}`}
			>
	...
	return (
		<div className={`px-4 overflow-auto h-full font-mono bg-background ${className}`}>
